...
\begin{itemize}
\item s = 12 for monthly data with yearly seasonality
\item s = 4 for quarterly data with yearly seasonality
\item s = 7 for daily data with weekly seasonality
\item s = 52 for weekly data with yearly seasonality
\end{itemize}
...
### Disadvantages
 * seasonality is assumed to be fixed (relatively small disadvantage)
